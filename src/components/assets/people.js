...
const cohortEightProfiles = [
  ...
  },
  {
    ...
    headshot: "",
    funnyPhoto: "",
    bio: "Yeah I guess I love to code and stuff.",
  },
  {
    name: "James Wang",
    headshot: "",
  ...
  },
  {
    ...
    headshot: "",
    funnyPhoto: "",
    bio: "Yo whats poppin! I'm Jack (of all trades) and I am creative and entrepreneurial with a desire to design innovative products and businesses. Before college I started a business to create fashionable ankle support gear, another to sell produce with the mission to impact food insecurity, and built an experiential public mural viewing station, all of which provided me invaluable experience. People describe me as passionate, fun, resourceful, loyal, diligent, and both a leader and a team player. I like to think I look at the world differently and offer unique perspectives and solutions. My varied interests range from sports, technology, photography, music, and design to finding ways to give back to society and to disrupt the norm.",
  },
  {
    name: "Soph Shack",
    headshot: "",
    funnyPhoto: "",
    bio: "Heyo I'm Soph, aka Soph the Loaf! I love to drive with the windows down and the music up, explore the outdoors, and dapple in digital, 3D, and experience design. Things that make me happy include good food (sushi, tacos, and cookies are superior), theme parks, and checking off my bucket list. I wish I had perfect vision so I could buy any pair of glasses I wanted. In the future, I hope to travel to New Zealand (sheep outnumber people there!) and continue to do Tough Mudder every year until I’m an old lady. Being at IYA is a dream come true, especially among these amazing people! FIGHT ON!",
  },
  {
    name: "Zander Tate",
    headshot: "",
    funnyPhoto: "",
    bio: "Zander Tate is a freshman at the Academy from Houston, Texas. Zander is passionate about carpentry and creation. His ideal life would be to live in a cabin in the mountains where he can build in a wood shop, make art, and enjoy the outdoors. Zander also enjoys collecting and selling vintage clothing, working on cars, and meeting new people. When not working on something or talking to friends, he's probably listening to some country music and walking through campus. ",
  },
  {
    name: "Michael Steele",
    headshot: "",
    funnyPhoto: "",
    bio: "My creative background is in 3D modeling and physical building, but I dabble in graphic design and logo work as well! I love learning about new ways to create things, so I’ll likely spend most of my time in the the makerspace this year! I recently been getting into drawing and shading objects in perspective, making beats, and designing T-Shirts! I aspire to continue to create at my own pace and use my skills to help others. ",
  },
  {
    name: "Deniz Yamangul",
    headshot: "",
    funnyPhoto: "",
    bio: "Hi!! I am Deniz. I am from Istanbul, Turkey. I love binge watching a good crime show, so I screamed when I learned that How To Get Away With Murder was shot at USC. Most people don’t know that I can rap, but I memorized almost all of Kendrick Lamar’s songs. My biggest pet peeve is cheese: I cannot touch it, smell it, or put it in my mouth. I am also a very bad cook, I can burn everything, but I am a good boxer. Fun fact: I traveled almost all of Europe.",
  },
  {
    name: "Cristina Colina",
    headshot: "",
    funnyPhoto: "",
    bio: "Hi, my name is Cristina Colina! Welcome to the inner workings of my chaotic and ever-so curious mind. Some of my fun interests include hosting solo bedroom karaoke sessions, creating content, watching psychological thrillers, going on spunky outdoor adentures, and consuming a lot of popcorn. Additionally, some of my favorites movies and music artists include La La Land, Up, Inception, Dominic Fike, Brockhampton, and Hope Tala. One thing that most people don’t know about me is that my two biggest creative influences are Leonardo Davinci and Oprah Winfrey (fun combination, right?). I’m always up for discussing the state media industry, crypto, Disney, philosophy, pop culture, and pretty much anything else! I’m super excited for the next four years in the most disruptive program on the planet with the coolest set of students I’ve ever met 😎.",
  },
  {
    name: "Andrew Kim",
    headshot: "",
    funnyPhoto: "",
    bio: "What’s up! I’m Andrew I love designing experiences and art installations. I’m from Silicon Valley so anything tech related gets my blood pumping. I dress like a freshman in high school so if u got any fashion advice I NEED it. Currently watching Survivor szn 41 HMU if u watch survivor! If u know beau miles or tom Sachs hmu cause that’s my creative inspiration",
  },{
    name: "Marcos Angelini",
    headshot: "",
    funnyPhoto: "",
    bio: "I have many creative hobbies such as graphic design, fine art (sculptures mainly) and the clothing I design for my brand Marroc Clothing. I also love sports like snowboarding, soccer, rugby and skateboarding (as you can see by my pool ball chilling at the skatepark). I love listening to music and discovering new artists, and if anyone reading this needs a drummer for a band let me know @marcos.angelini_ on Instagram 👀",
  },{
    name: "Matthew Suri",
    headshot: "",
    funnyPhoto: "",
    bio: "Hi I’m Matthew and I’m super excited to be in IYA. Something most people don’t know about me was that I love to dance and was on 2 dance teams in high school. But one thing that will always happy is vibing to music, dancing or not. ",
  },{
    name: "Ellie Paik",
    headshot: "",
    funnyPhoto: "",
    bio: "Hi my name is Eleanor but most people call me Ellie or Ells! In my free time I can be found taking naps, eating Clif bars (specifically the chocolate brownie flavor), or falling on my skateboard. I am a military child and have lived in six states, three countries, and two continents throughout my nineteen years. However I can’t speak any language other than English :’(. Some hobbies I enjoy include painting, talking about coffee, and playing guitar. One thing most people don’t know about me is that I color coordinate my closet and hate patterns on all clothing :O. In the future I hope to sell my art to Kanye West for a million dollars. ",
  },{
    name: "Ezra Bird",
    headshot: "",
    funnyPhoto: "",
    bio: `Infamous Ezra activities: getting very excited and passionate about random ideas such as why monkeys are objectively the best animal, asking "what excites you about the future" to every guest lecturer, and making amazing projects. The best book hands down is Atomic Habits by James Clear, it doesn't matter who you are or where you are in your life it is applicable. I love talking to people and figuring out what they're passionate about. Seeing the gears turn in peoples heads and hearing the excitement as they dive into explaining their passions makes me so proud to be human.`,
  },{
    name: "Natalie So",
    headshot: "",
    funnyPhoto: "",
...
export default cohortEightProfiles;